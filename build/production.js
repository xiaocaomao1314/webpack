...
//htmlPlugin打包生产的html文件动态的引入其他的js文件
const AddAssetHtmlPlugin = require('add-asset-html-webpack-plugin');
console.log(TerserPlugin, "js压缩是否生效")
    // webpacl - merge 合并到生产模式下
...
module.exports = merge(base, {
    ...
    plugins: [
        ...
        new AddAssetHtmlPlugin({ filepath: path.resolve(__dirname, '../dist/react_dll.js') }),
    ]
})